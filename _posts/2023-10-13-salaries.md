...
Source code for the project if you want to follow along can be found here <a href="https://github.com/brady-heinig/brady-heinig.github.io/blob/main/nba_salary_regression.ipynb" target="_blank">here </a>
### **Load in the Data**
