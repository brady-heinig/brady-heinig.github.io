...
I was interested in looking at both players dominance at an individual game level and also when zooming out and looking at seasons as a whole. The tricky part about the structure of this website is that the data for each season is located on a different page. This required some adjustments on my part in order to properly collect the data.
